            ...
            {user?.role === "manager" && (
                <div className="max-w-6xl mx-auto mb-6 flex justify-end">
                    <button
                        ...
                        className="bg-gradient-to-r from-purple-600 to-blue-600 text-white px-5 py-3 rounded-full text-sm font-medium flex items-center gap-2 shadow-md hover:scale-105 transition-all"
                    >
                        <Briefcase size={18} />
                        Manage Tasks
                    </button>
