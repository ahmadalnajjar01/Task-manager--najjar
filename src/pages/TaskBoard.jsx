    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
        ...
        <div className="flex justify-end mb-6">
          <button
            className="flex items-center gap-2 bg-gradient-to-r from-purple-600 to-blue-600 text-white px-5 py-2 rounded-full shadow-md hover:bg-blue-700 transition-all"
          ...
          <div className="fixed inset-0 bg-gray-900/50 backdrop-blur-lg flex items-center justify-center z-50">
            ...
            <CreateTaskForm
              onAddTask={(task) => {
                setTasks([
                  ...tasks,
                  { id: Date.now().toString(), ...task, status: "todo" },
                ]);
                ...
                <TaskColumn
                  ...
                  tasks={filteredTasks.filter(
                    (task) =>
                      ...
                      task.status.toLowerCase() === statusKey
                  )}
                  setTasks={setTasks}
